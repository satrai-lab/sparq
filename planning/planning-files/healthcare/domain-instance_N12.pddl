...
(:action strategy-20
		...
		(not (mitigation-applied ?d))
		 ...
		 :effect (and
		 	(increase (avg_lik) 0.2987991039165565)
		 	(increase (avg_imp) %avg_imp%)
		 	(increase (avg_risk) 0.1266194960757691)
		 	(increase (avg_len) 1.3837879369957742)
        (increase (num_paths) 2602.0)
